...
<template>
    ...
    <svg version="1.1" width="100" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" viewBox="0 0 450 290" style="enable-background:new 0 0 450 290;" xml:space="preserve">
        <path class="signature-path" fill="transparent" stroke="var(--white)" d="M117.64,160.65c-5.41,1.84-10.81,3.67-16.22,5.51c9.35-50.47,43.25-95.81,89.01-119.05
